...
# ข้อมูล Subgrade
SUBGRADE_OPTIONS = {
    "ทรายคันทาง CBR 3%": {"CBR": 3, "MR_psi": 4500},
    "ทรายคันทาง CBR 5%": {"CBR": 5, "MR_psi": 7500},
    "ทรายคันทาง CBR 6%": {"CBR": 6, "MR_psi": 9000},
    "ทรายคันทาง CBR 10%": {"CBR": 10, "MR_psi": 15000},
    "ดินถมคันทาง CBR 5.8%": {"CBR": 5.8, "MR_psi": 8700},
}
...
if st.button("🔢 คำนวณความหนาผิวทางคอนกรีต", type="primary", use_container_width=True):
    ...
    with res_col2:
        ...
        if D_required and D_required <= 20:
            ...
            # ปรับเป็นความหนามาตรฐาน (28, 30, 32, 34 cm)
            standard_thicknesses = [28, 30, 32, 34, 36]
    ...
    thickness_options = [
        ...
        {"D_inch": 13, "D_cm": 33, "label": "D=13\" (33 ซม.)"},
