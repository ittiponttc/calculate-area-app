...
J = st.sidebar.slider(
    ...
    help="ค่า J ขึ้นอยู่กับประเภทไหล่ทางและอุปกรณ์ถ่ายแรง,JPCP/JRCP ไหล่ทางคอนกรีต 2.5-3.5 ค่ากลาง 2.8,CRCP ไหล่ทางคอนกรีต 2.3-2.9 ค่ากลาง 2.5, ค่า J หากใช้ค่าน้อย==>ความหนาผิวทาง>>บางลง"
)

Cd = st.sidebar.slider(
    "Drainage Coefficient (Cd)",
    min_value=0.70, max_value=1.25, value=1.20, step=0.05,
    help="ค่าสัมประสิทธิ์การระบายน้, ค่าแนะนำโดยกรมทางหลวง = 1.0,ค่า Cd หากมีค่ามาก==>ความหนาผิวทาง>>บางลง"
)
